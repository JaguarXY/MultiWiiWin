...
namespace MultiWiiWinGUI
{
    ...
    public class MSP
    {
        ...
        public const byte MSP_USE_DEBUG = 252;     //自己的Debug
        public const byte MSP_USE_RTH = 50;       //返航
        public const byte MSP_USE_DROP_BOOM = 51;  //投弹指令
        public const byte MSP_USE_DROP_STATUS = 52; //投弹状态
        public const byte MSP_GPS_AIR_SPEED = 55;     //空速
