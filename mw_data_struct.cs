...
namespace MultiWiiWinGUI
{
    ...
    public class GUI_settings
    {
        ...
        public bool read_from_xml(string filename)
        {
            ...
            //return (true);
            #region Read XML in second time
    ...
    public class mw_settings
    {
        ...
        //New para! 20190727
        public Int16 drop_delay_ms;
        public UInt16 drop_servor_open;
        public UInt16 drop_servor_close;
        ...
        public void write_settings( SerialPort serialport, int cbItems, bool extended_aux)
        {
            ...
            //    while (serialport.BytesToWrite > 0) ;
                ...
                //New Write para !20190727
                buffer[bptr++] = (byte)(drop_delay_ms & 0x00ff);
                buffer[bptr++] = (byte)((drop_delay_ms >> 8) & 0x00ff);

                buffer[bptr++] = (byte)(drop_servor_open & 0x00ff);
                buffer[bptr++] = (byte)((drop_servor_open >> 8) & 0x00ff);

                buffer[bptr++] = (byte)(drop_servor_close & 0x00ff);
                buffer[bptr++] = (byte)((drop_servor_close >> 8) & 0x00ff);
...
//
    ...
    public class mw_data_gui
    {
        ...
        public byte is_Dropping;          //投弹返回
        public byte drop_status = 0;          //投弹状态
        ...
        //U_Debug
        public int u_debug0, u_debug1, u_debug2, u_debug3, u_debug4, u_debug5, u_debug6, u_debug7;
